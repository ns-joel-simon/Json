...
#
#         self.browse_button = tk.Button(root, text="Browser", command=self.browse_file)
...
#
# self.success_label.config(text="Conversation successful! Result saved in result/result.json")
